  ...
  const features = [
    {
      ...
      description: "Professional certificate with your name and typing speed"
    },
    {
      icon: faTrophy,
      title: "Government Exam Ready",
      description: "Perfect for CPCT, SSC, RRB, Police and other exams"
    },
    {
      icon: faDownload,
      title: "Instant Download",
      description: "Download immediately after completing 3 tests"
    },
    {
      icon: faCheckCircle,
      title: "Verification Code",
      description: "Unique verification code for authenticity"
    }
  ];
        ...
        <div className="features-grid">
          {features.map((feature, index) => (
            <div key={index} className="feature-card">
              <FontAwesomeIcon icon={feature.icon} style={{ fontSize: '24px', color: '#1976d2', marginBottom: '10px' }} />
              <h3>{feature.title}</h3>

...
const AIIMSCRCTest = () => (
  <div>
    ...
    {/* AIIMS CRC Typing Test Information */}
    <div style={{
      maxWidth: '1200px',
      margin: '40px auto',
      padding: '0 20px'
      ...
      <div style={{
          ...
          <div style={{
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <strong>Content:</strong> Medical and administrative
              </li>
              <li style={{
                padding: '8px 0',
                borderBottom: '1px solid #f0f0f0',
        ...
        <div style={{
          ...
          <p style={{
            ...
            The AIIMS CRC typing test is conducted for various positions in AIIMS (All India 
            Institute of Medical Sciences) including clerical and administrative posts. The test 
            includes medical terminology, administrative content, and official communications. 
            Candidates should practice typing medical and administrative documents.
          </p>
        </div>
      </div>
    </div>

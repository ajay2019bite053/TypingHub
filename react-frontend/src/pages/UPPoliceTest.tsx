...
const UPPoliceTest = () => (
  <div>
    ...
    {/* Comprehensive UP Police Typing Test Information */}
    <div style={{
      maxWidth: '1200px',
      margin: '40px auto',
      padding: '0 20px'
      ...
      <div style={{
        ...
        <p style={{
          ...
          The UP Police typing test is conducted for various police department posts including Constable, 

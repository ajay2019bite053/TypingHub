...
const JuniorCourtAssistantTest = () => (
  <div>
    ...
    {/* Junior Court Assistant Typing Test Information */}
    <div style={{
      maxWidth: '1200px',
      margin: '40px auto',
      padding: '0 20px'
      ...
      <div style={{
          ...
          <div style={{
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <strong>Content:</strong> Legal documents, judgments
              </li>
              <li style={{
                padding: '8px 0',
                borderBottom: '1px solid #f0f0f0',
        ...
        <div style={{
          ...
          <p style={{
            ...
            The Junior Court Assistant typing test is conducted for court clerical positions 
            in various High Courts and District Courts. The test emphasizes high accuracy 
            over speed, focusing on legal documents, court judgments, and official 

...
const BiharPoliceTest = () => (
  <div>
    <TypingEngine config={config} />
    
    {/* Comprehensive Bihar Police Typing Test Information */}
    <div style={{
      maxWidth: '1200px',
      margin: '40px auto',
      padding: '0 20px'
      ...
      <div style={{
        ...
        <p style={{
          ...
          Essential typing assessment for various police department posts including Constable, Head Constable, 
          and other clerical positions. Includes police reports, legal documents, and official communications.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: '#333', margin: 0, fontSize: '15px' }}>
              <strong>Police computers only</strong> - No personal devices
            </p>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ background: '#4caf50', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '14px' }}>30 WPM</span>
              </div>
              <div style={{
                display: 'grid',
                gridTemplateColumns: '1fr auto',
                ...
                <span style={{ background: '#4caf50', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '14px' }}>80-85%</span>
              </div>
              <div style={{
                display: 'grid',
                gridTemplateColumns: '1fr auto',
          ...
          <div>
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <span>Police specialized software will be used for test administration</span>
              </li>
              <li style={{
                padding: '10px 0',
                borderBottom: '1px solid #e8f5e8',
              ...
              <li style={{
                ...
                <span style={{ color: '#4caf50', fontSize: '18px' }}>✓</span>
                <span>Police reports and legal documents are included</span>
              </li>
              <li style={{
                padding: '10px 0',
                color: '#333',
          ...
          <div>
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <span><strong>Police Reports:</strong> Incident reports and case details</span>
              </li>
              <li style={{
                padding: '8px 0',
                color: '#333',
                ...
                <span style={{ color: '#ff9800', fontSize: '16px' }}>•</span>
                <span><strong>Legal Documents:</strong> FIRs and court documents</span>
              </li>
              <li style={{
                padding: '8px 0',
                color: '#333',
                ...
                <span style={{ color: '#ff9800', fontSize: '16px' }}>•</span>
                <span><strong>Administrative Content:</strong> Police procedures and rules</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <span style={{ color: '#ff9800', fontSize: '16px' }}>•</span>
                <span><strong>English:</strong> Primary language for official documents</span>
              </li>
              <li style={{
                padding: '8px 0',
                color: '#333',
          ...
          <div>
            ...
            <ul style={{
              ...
              <li style={{
                ...
                <span><strong>Police Terminology:</strong> Practice typing police-related terms</span>
              </li>
              <li style={{
                padding: '8px 0',
                color: '#333',
              ...
              <li style={{
                ...
                <span style={{ color: '#9c27b0', fontSize: '16px' }}>•</span>
                <span><strong>Legal Documents:</strong> Familiarize with police document formats</span>
              </li>
            </ul>
          </div>
      ...
      <div style={{
        ...
        <p style={{
          ...
          The Bihar Police typing test is conducted for various police department posts including Constable, 
          Head Constable, and other clerical positions. <strong>Practice typing police-related content and 
          legal terminology</strong> to improve your performance. Focus on maintaining a balance between 
          speed and accuracy, as both are equally important for police positions.
        </p>
      </div>
    </div>
  </div>
